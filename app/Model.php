 ...
 class Model
 {
     ...
     public function buscarAlimentosPorEnergia($energia)
     {
         ...
         $sql = "select * from alimentos where energia = " . $energia . " order by nombre asc";
     ...
     public function buscarAlimentosCombinada($nombre, $grasa)
     {
         $nombre = htmlspecialchars($nombre);
         $grasa = htmlspecialchars($grasa);

         $sql = "select * from alimentos where nombre like '" . $nombre . "' and grasatotal = " . $grasa . " order by nombre asc ";
